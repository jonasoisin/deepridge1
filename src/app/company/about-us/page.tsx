...
export const metadata: Metadata = {
    title: 'About Us | Sovereign Renewables',
    description: 'Learn about Sovereign Renewables, our mission, vision, and leadership in the sustainable energy sector.',
};
        ...
        <main className="min-h-screen bg-background-light text-slate-900 py-24">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="border-l-4 border-red-500 pl-6 mb-12">
                    <h1 className="text-4xl font-bold mb-4 font-display">About Sovereign Renewables</h1>
                ...
                <div className="prose max-w-none text-slate-600">
                    ...
                    <div className="mb-12">
                        <h3 className="text-xl font-semibold mb-2 text-slate-800">Sovereign Renewables in brief</h3>
                        <p className="mb-4">
                            Sovereign Renewables is an international energy company present in more than 14 countries worldwide, including several of the world's most important oil and gas provinces. Founded in 1992 under the name Sovereign Renewables Construction Company, we changed our name to Sovereign Renewables in 2010. Our headquarters is in Boise, Idaho USA, and we have over 2,000 employees.
                        </p>
                    </div>
                    ...
                    <div className="mb-12">
                        ...
                        <p className="mb-4">
                            Traditionally, most of Sovereign Renewables's gas has been sold through long-term contracts to large European gas companies and suppliers. In the absence of a separate market price for gas, the sale price has often been indexed to the price of oil.
                        </p>
                        <p className="mb-4">
                    ...
                    <div className="mb-12">
                        ...
                        <p className="mb-4">
                            We seek to work with others who share our commitment to ethics and compliance. We believe in the benefits of competition, and Sovereign Renewables always competes in a fair and ethically justifiable manner.
                        </p>
                    </div>
