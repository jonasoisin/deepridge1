...
export const metadata: Metadata = {
    title: 'Support | Sovereign Renewables',
        ...
        <main className="min-h-screen bg-background-light text-slate-900 py-24">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <Link href="/contact" className="block p-6 border border-slate-200 rounded-lg hover:border-red-500 transition-colors group">
                    ...
                    <Link href="/support/global-locations" className="block p-6 border border-slate-200 rounded-lg hover:border-red-500 transition-colors group">
                    ...
                    <Link href="/support/ethics-compliance" className="block p-6 border border-slate-200 rounded-lg hover:border-red-500 transition-colors group">
                    ...
                    <Link href="/legal/privacy-policy" className="block p-6 border border-slate-200 rounded-lg hover:border-red-500 transition-colors group">
