    ...
    return (
        ...
        >
            <AnimatePresence mode="wait">
                ...
                >
                    {/* Using img tag directly for external URLs to avoid Next.js Image config issues for now, or could use Next Image if domains added to config */}
                    <img
                        src={currentLogo.src}
                        alt={currentLogo.name}
                        className="h-auto w-auto max-h-[80%] max-w-[80%] object-contain grayscale hover:grayscale-0 transition-all duration-300"
                    />
                </motion.div>
            </AnimatePresence>
        </motion.div>
