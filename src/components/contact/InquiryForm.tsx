        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                    ...
                    <form action="#" className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    className="w-full bg-surface-light dark:bg-surface-dark border border-black focus:border-red-500 focus:ring-0 transition-all p-4 rounded-sm"
                                    required
                                    type="text"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            <select className="w-full bg-surface-light dark:bg-surface-dark border border-black focus:border-red-500 focus:ring-0 transition-all p-4 rounded-sm text-slate-900 border-r-8 border-transparent">
                ...
                <div className="space-y-12">
                    <div className="bg-surface-light dark:bg-surface-dark p-8 rounded-sm">
                    ...
                    <div className="p-8 border border-red-500 dark:border-red-500 rounded-sm">
                        <h3 className="text-xl font-display font-bold mb-6">Stay Connected</h3>
                        <div className="flex gap-4">
                            <Link href="#" className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-700 flex items-center justify-center hover:bg-primary hover:text-white transition-all text-slate-600">
