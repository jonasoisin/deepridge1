            ...
            <div className="flex flex-col lg:flex-row gap-16 items-center">
                <div className="lg:w-1/2">
                    ...
                    <p className="text-gray-600 mt-6 mb-12 text-lg leading-relaxed">
                        Sovereign Renewables operates across 24 countries, managing over $140 billion in energy assets. Our project development pipeline focus is centered on regions with high potential for renewable transition and existing infrastructure optimization.
                    </p>
