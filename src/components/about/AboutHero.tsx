export function AboutHero() {
    return (
        <section className="relative h-[700px] flex items-center overflow-hidden">
            <img
                alt="Engineers at sovereign renewables site"
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full">
                <div className="max-w-2xl">
                    ...
                    <p className="text-xl text-slate-200 mb-8 leading-relaxed">
                        Sovereign Renewables is a global leader in sustainable extraction and floating offshore wind technology. We engineer the bridge to a cleaner future through innovation and integrity.
                    </p>
