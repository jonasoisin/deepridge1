            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
                    ...
                    <div className="bg-white p-8 shadow-sm border border-red-500 hover:shadow-xl transition-shadow">
                        ...
                        <p className="text-slate-600 text-sm leading-relaxed mb-6">Our advisory clients rely on our models to give them a competitive advantage in negotiation. Our models must therefore be robust and flexible but above all clear and transparent. Too often modelling is left to the least experienced team member; at Sovereign Renewables we give modelling to the senior level management it requires.</p>
                    </div>
                </div>
            </div>
        </section>
